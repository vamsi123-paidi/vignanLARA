...
// main.innerHTML = "<h1>this is the inner text</h1>"

// main.innerHTML = `
// <h1>this is content</h1>
//       <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellendus doloribus, id ea dignissimos expedita eligendi rem consectetur eveniet laborum minima laudantium vel libero nobis corrupti at debitis eius. Iure, dignissimos.</p>
...
alertBtn.addEventListener('dblclick',()=>{
    const name = "adam"
    alert(`hello ${name}`)
})
